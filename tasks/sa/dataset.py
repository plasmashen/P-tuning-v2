...
class SADataset():
    def __init__(self, tokenizer: AutoTokenizer, data_args, training_args) -> None:
        ...
        if training_args.do_train:
            df_train = pd.read_csv(f"/home/Lujia/Datasets/sentiment_data/{data_args.dataset_name}/train.tsv", sep="\t")
        ...
        if training_args.do_eval:
            if not training_args.do_train:
                df_train = pd.read_csv(f"/home/Lujia/Datasets/sentiment_data/{data_args.dataset_name}/train.tsv",
                                       sep="\t")
        ...
        if training_args.do_predict or data_args.dataset_name is not None or data_args.test_file is not None:
            df_dev = pd.read_csv(f"/home/Lujia/Datasets/sentiment_data/{data_args.dataset_name}/dev.tsv", sep="\t")
